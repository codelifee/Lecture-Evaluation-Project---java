...
%>
	...
	<section class="container">
	 <form method="get" action="./index.jsp" class="form-inline mt-3">
	  ...
	  <a class="btn btn-primary mx-1 mt-2 btn-danger" data-toggle="modal" href="#reportModal">신고</a>
	 </form>
	 <div class="card bg-light mt-3">
		...
		<div class="card-body">
			...
			<p class="card-text">강의가 많이 널널해서, 솔직히 많이 배운 거 없는 것 같지만 학점도 잘 나오고 너무 좋은 것 같습니다.</p>			
			<div class="row">
	...
	<footer class="bg-dark mt-4 p-5 text-center fixed-bottom" style="color: #FFFFFF;">
		Copyright &copy; 2018 정수민 ALL Rights Reserved.
	</footer>
	<!-- 제이쿼리 자바스크립트 추가하기 -->
